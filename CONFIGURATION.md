...
+ `games_list_days`: limits how far back the games dashboard looks when it lists games. Files older than this many days are ignored to keep the page fast. Defaults to `7`; set to `0` or omit to disable the limit.
